...
As stated in the introduction, this paper is preliminary. As more data becomes avaiable with the relase of June figures, the whole analysis will be rerun to see if the results align more with theoretical expectations or if there's potential variables that we have missed. 
